...
public interface KalkulatorLiczbWymiernychListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link KalkulatorLiczbWymiernychParser#operacja1}.
	 * @param ctx the parse tree
	 */
	void enterOperacja1(KalkulatorLiczbWymiernychParser.Operacja1Context ctx);
	/**
	 * Exit a parse tree produced by {@link KalkulatorLiczbWymiernychParser#operacja1}.
	 * @param ctx the parse tree
	 */
	void exitOperacja1(KalkulatorLiczbWymiernychParser.Operacja1Context ctx);
	/**
